...
namespace GE{
  namespace Geometry {
    ...
    PlaneGeometry::PlaneGeometry(float width, float height, unsigned int width_segments, unsigned int heigth_segments) :
      m_width(width),
      m_height(height),
      ...
      m_width_segments(width_segments)
    {
      ...
      float segmentWidth = static_cast<float>(m_width) / static_cast<float>(m_width_segments);
      float segmentHeight = static_cast<float>(m_height) / static_cast<float>(m_heigth_segments);
