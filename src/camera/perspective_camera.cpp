...
void PerspectiveCamera::Calculate_View_Matrix() {
    cam_View_Matrix = glm::lookAt(cam_Pos, cam_Pos + cam_Front, cam_Up); //TODO: Move to function
}

void PerspectiveCamera::Calculate_Projection_Matrix() {
    cam_Projection_Matrix = glm::perspective(glm::radians(m_fov), m_aspect, m_near, m_far);
}
